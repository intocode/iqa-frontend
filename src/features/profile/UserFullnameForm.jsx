...
const UserFullnameForm = () => {
  ...
  return (
    <Modal open={isModalOpened} footer={null} destroyOnClose>
      <div>
        <StyledModalHeading>Введите полное имя и почту, чтобы продолжить</StyledModalHeading>
        <div className="mt-3">
          {!profile.fullName && (
            <Input
              value={userFullName}
          ...
          <StyledButtonBlock>
            <Button className="mt-3" disabled={!userFullName} onClick={handleSubmit} type="button">
              Сохранить
            </Button>
          </StyledButtonBlock>
        </div>
